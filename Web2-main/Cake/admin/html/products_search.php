...
include($_SERVER['DOCUMENT_ROOT'] . "/admin/html/product_model.php");
...
$ProductsResult = $productModel->searchProducts($searchQuery);
$total = $ProductsResult->num_rows; // Đếm số lượng sản phẩm
...
$ProductsResult = $productModel->searchProducts($searchQuery, $start, $limit);
